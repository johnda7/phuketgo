      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3 cursor-pointer" onClick={onBackToMain}>
            ...
            <div>
              <h1 className="text-xl font-bold bg-gradient-to-r from-cyan-600 to-teal-500 bg-clip-text text-transparent">
                ПХУКЕТ GO
              </h1>
              <p className="text-xs text-gray-500">Экскурсии по Пхукету</p>
            </div>
          </div>
